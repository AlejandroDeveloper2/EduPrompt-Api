...
export function ResetPasswordEmail({ userName, verificationCode }: Props) {
  return (
    <Html lang="es">
      <Body
      ...
      >
        ...
        >
          ...
          >
            Has solicitado el cambio de contraseña de acceso a tu cuenta de
            EduPrompt. Dentro de la app ingresa el siguiente código de
            verificación para reestablecer tu contraseña. El código tiene una
          ...
          <Section style={{ textAlign: "center" }}>
            ...
            >
              <Img
                src="https://res.cloudinary.com/dy3rkkfjw/image/upload/v1774405212/lock-icon_rlfoyi.png"
                width="30"
                height="30"
                alt="lock-icon"

...
export class FindUserByEmailUseCase {
  ...
  /**
   * Recupera un usuario por su correo electrónico único.
   *
   * @param email - Correo electrónico único del usuario a recuperar.
   * @returns Una promesa que resuelve con el objeto {@link User} encontrado.
   * @throws {AppError} Si no se encuentra un usuario con el Email proporcionado, lanza un error con código 404.
   */
